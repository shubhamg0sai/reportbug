...
icon.item()
print (red.Color+'###################################################################')
print ('## '+cyan.Color+'[●] This tool is specifically for Gmail and Yahoo users!'+red.Color+'      ##')
...
if inputbug == '1':
    ...
    <th class="thtwo">
    reported using bugreport tools<br>tools made by <a href="https://www.instagram.com/shubham_g0sain/">shubhamg_0sain</a>
    </th>
    ...
    print ('[●] Ex : /storage/emulated/0/Document/reportbug.pdf')
    print ('[●] Ex : /storage/emulated/0/Pictures/reportbug.jpg')
    print ('[●] Ex : /storage/emulated/0/Recorder/reportbug.mp4')
    print (yellow.Color+'═══════════════════════════════════════════════════')
    ...
    tableclose = '''</p></td></tr><tr>
    <th class="thtwo">
    reported using reportbug tools<br>tools made by <a href="https://www.instagram.com/shubham_g0sain/">shubham_g0sain</a>
    </th>
    </tr></table></td></tr></table></body></html>
    '''
    ...
    if urlsite:
        ...
        print (yellow.Color+'═══════════════════════════\n')
        exit()
    closemail = '<br><br>dengan laporan ini semoga  reportbug saya dapat diterima dengan baik, terimakasih.'
    respect = '<br><br>Hormat saya,<br>'
    print (green.Color+'╭━━¤'+yellow.Color+' [Enter Your Name]')
    yourname = input(green.Color+'╰━━¤ √  : ')
    if yourname:
    ...
    sys = system('cd .. && rm -rf bugreport && git clone https://github.com/shubhamggosai/reportbug.git')
